...
export const translations = {
  'pt-BR': {
    ...
    contact: {
      ...
      direct_desc: 'Entre em contato direto pelos canais abaixo para respostas rápidas:',
  ...
  'en-US': {
    ...
    contact: {
      ...
      direct_desc: 'Get in touch directly through the channels below for quick responses:',
  ...
  'es-ES': {
    ...
    contact: {
      ...
      direct_desc: 'Póngase en contacto directamente a través de los canales siguientes para respuestas rápidas:',
